...
var fight = function(enemy) {
  ...
  while (playerInfo.health > 0 && enemy.health > 0) {
    if (isPlayerTurn) {
      ...
      console.log(playerInfo.name + " attacks " + enemy.name + ". " + enemy.name + " now has " + enemy.health + " hp.");
      ...
      if (enemy.health <= 0) {
        ...
        window.alert(enemy.name + " still has " + enemy.health + " hp.");
      }
      ...
      console.log(
        enemy.name + " attacks " + playerInfo.name + ". " + playerInfo.name + " now has " + playerInfo.health + " hp.");
      ...
      if (playerInfo.health <= 0) {
        ...
        window.alert(playerInfo.name + " still has " + playerInfo.health + " hp.");
      }
    }
...
var endGame = function() {
  ...
  // check localStorage for high score. if absent, use 0
  ...
  // if player has more $$ than the high score, player's $$ is new high score
  if (playerInfo.money > highScore) {
    localStorage.setItem("highscore", playerInfo.money);
    localStorage.setItem("name", playerInfo.name);
    alert(playerInfo.name + " has the high score of " + playerInfo.money + ".");
  } else {
    alert(playerInfo.name + " did not beat the high score of " + highScore + ". Try harder next time");
  }
  ...
  if  (playAgainConfirm) {
    ...
    window.alert("np, come back soon.");
  }
};
